...
int main(int argc, char* argv[]){
	...
	MPI_Allreduce(&my_lucky_number, &global_min, 1, MPI_INT, MPI_MIN,  MPI_COMM_WORLD);			
	MPI_Allreduce(&my_lucky_number, &global_max, 1, MPI_INT, MPI_MAX, MPI_COMM_WORLD);			
	MPI_Allreduce(&my_lucky_number, &global_sum, 1, MPI_INT, MPI_SUM, MPI_COMM_WORLD);			
