...
typedef struct array array_t;//forma de hacer atributos privados

static const size_t array_not_found = (size_t)-1;

array_t * array_create(size_t capacity);
void array_destroy(array_t* array);
int array_append(array_t* array, void* element);// en vez de array, se puede llamar this (por alguna razon)
